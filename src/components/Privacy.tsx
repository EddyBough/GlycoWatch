    ...
    <section className="mb-16 w-full">
      ...
      <div className="flex flex-col md:flex-row items-start justify-between gap-12">
        <div className="w-full flex flex-col bg-white/20 backdrop-blur-sm rounded-2xl shadow-xl p-6 mb-8">
          ...
          <h3 className="text-xl font-bold mb-2">1. Collecte des Données</h3>
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            Dans le cadre de l&apos;utilisation de l&apos;application GlycoWatch, nous
            collectons uniquement les informations nécessaires pour vous fournir
            un service optimal. Cela inclut notamment vos informations de
            connexion (nom, prénom, adresse e-mail) et, le cas échéant, des
            données de santé telles que vos niveaux d’insuline et votre
            historique de mesures.
          </p>

          <h3 className="text-xl font-bold mb-2">2. Utilisation des Données</h3>
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold mb-2">3. Accès aux Données</h3>
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            Seul vous, en tant qu&apos;utilisateur de l&apos;application, avez un accès
            complet à vos données de santé. Nos équipes techniques peuvent
            exceptionnellement accéder aux données, mais seulement à des fins de
            support technique et de maintenance, et toujours en respectant les
            normes strictes de confidentialité.
          </p>

          <h3 className="text-xl font-bold mb-2">4. Sécurité des Données</h3>
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold mb-2">5. Vos Droits</h3>
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
          ...
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            ...
            suivre l&apos;évolution des réglementations ou pour toute amélioration du
            service. Nous vous informerons en cas de changements importants.
          </p>
        </div>
      </div>
    </section>
